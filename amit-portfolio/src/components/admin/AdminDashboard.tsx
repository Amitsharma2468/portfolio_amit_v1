...
export function AdminDashboard({ onLogout }: AdminDashboardProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <div className="border-b border-purple-500/20 bg-slate-900/80 backdrop-blur-md">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Tabs
          ...
          className="space-y-6"
        >
          <TabsList className="grid w-full grid-cols-6 bg-slate-800 border border-purple-500/20">
            <TabsTrigger
              value="skills"
